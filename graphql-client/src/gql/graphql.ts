...
export type StarshipItemFragment = {
  __typename?: "Starship";
  id: string;
  name?: string | null;
  model?: string | null;
} & { " $fragmentName"?: "StarshipItemFragment" };

export type AllStarshipsWithVariablesQueryQueryVariables = Exact<{
  first: Scalars["Int"]["input"];
}>;

export type AllStarshipsWithVariablesQueryQuery = {
  __typename?: "Root";
  allStarships?: {
    __typename?: "StarshipsConnection";
    edges?: Array<{
      ...
      node?:
        | ({ __typename?: "Starship" } & {
            " $fragmentRefs"?: { StarshipItemFragment: StarshipItemFragment };
          })
        | null;
    } | null> | null;
  } | null;
...
export const StarshipItemFragmentDoc = new TypedDocumentString(
  `
  ...
  model
    ...
    `,
  { fragmentName: "StarshipItem" },
) as unknown as TypedDocumentString<StarshipItemFragment, unknown>;
...
>;
export const AllStarshipsWithVariablesQueryDocument = new TypedDocumentString(`
  ...
  AllStarshipsWithVariablesQueryQuery,
  AllStarshipsWithVariablesQueryQueryVariables
>;
/** All built-in and custom scalars, mapped to their actual values */
export type Scalars = {
  ID: { input: string; output: string };
